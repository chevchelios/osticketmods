...
if($amb && $_REQUEST['a']!='add'){
    ...
    $title='Add New Ambiente';
    $action='add';
    $submit_text='Add Ambiente';
...
?>
<form action="ambientes.php?<?php echo $qstr; ?>" method="post" id="save">
 <?php csrf_token(); ?>
...
<p style="padding-left:225px;">
    ...
    <input type="button" name="cancel" value="Cancel" onclick='window.location.href="ambientes.php"'>
</p>
</form>
